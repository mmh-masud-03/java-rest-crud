 ...
 */
package features.billpaymentcalling.api;

import core.utility.JsonDecoder;
import features.billpaymentcalling.dao.BillPaymentCallingDao;
 ...
 * @author mobileapps1
 */
@WebServlet(name = "BillPaymentCallingApi", urlPatterns = {"/v1/bill-payment-calling-api"})
public class BillPaymentCallingApi extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet BillPaymentApi</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet BillPaymentApi at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DPDCBillPaymentCallingReqDto req = new DPDCBillPaymentCallingReqDto();
            req.setBillNo(billNo);
            req.setMobileNo(mobileNo);

            BillPaymentCallingDao dao = new BillPaymentCallingDao();
            DPDCBillPaymentCallingResDto res = dao.payDpdcBill(req);
